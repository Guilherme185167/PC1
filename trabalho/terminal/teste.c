...
play_tone(pcm, G4, 300); 
play_tone(pcm, A4, 500); 
play_tone(pcm, B4, 500); 
play_tone(pcm, A4, 300); 
play_tone(pcm, G4, 500); 
usleep(2000);
play_tone(pcm, C5, 300); 
play_tone(pcm, D5, 500); 
play_tone(pcm, E5, 500); 
play_tone(pcm, D5, 300); 
play_tone(pcm, C5, 500); 
usleep(2000);
play_tone(pcm, G4, 300); 
play_tone(pcm, A4, 500); 
play_tone(pcm, B4, 500); 
play_tone(pcm, A4, 200); 
play_tone(pcm, G4, 500);
usleep(800);
play_tone(pcm, D4, 800); 
play_tone(pcm, F4S, 500); 
play_tone(pcm, G4, 300); 
play_tone(pcm, A4, 500); 
play_tone(pcm, G4, 1000); 
